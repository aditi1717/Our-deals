...
function Footer() {
  ...
  return (
    <footer className="w-full bg-[#1A3760] text-white py-[clamp(20px,2.5vw,40px)] px-[clamp(12px,1.5vw,20px)]">
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-3 gap-[clamp(8px,1vw,24px)] mb-[clamp(16px,2vw,28px)]">
          ...
          {/* Quick Links */}
          <div className="flex flex-col">
            <h3 className="text-[14px] font-bold text-white mb-[clamp(6px,0.8vw,12px)]">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div className="flex flex-col">
            <h3 className="text-[14px] font-bold text-white mb-[clamp(6px,0.8vw,12px)]">Contact</h3>
            <div className="flex flex-col gap-[clamp(4px,0.6vw,10px)]">
              ...
              <div className="flex items-center gap-[clamp(4px,0.6vw,8px)]">
                ...
                <span className="text-[clamp(8px,1vw,12px)] text-white break-words">123 Business Street, City, State</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/30 pt-[clamp(12px,1.5vw,20px)] mt-[clamp(12px,1.5vw,20px)]">
          <p className="text-center text-[clamp(8px,1vw,12px)] text-white m-0">&copy; 2024 Our Deals. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
