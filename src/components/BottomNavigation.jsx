    ...
    <>
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-evenly items-center py-1.5 z-[1000] shadow-[0_-2px_8px_rgba(0,0,0,0.1)] min-h-[56px] md:hidden">
        ...
        >
          ...
          <span className="text-[10px] font-medium leading-tight whitespace-nowrap overflow-hidden text-ellipsis max-w-full">Home</span>
        </button>
        <button 
          type="button"
        ...
        >
          ...
          <span className="text-[10px] font-medium leading-tight whitespace-nowrap overflow-hidden text-ellipsis max-w-full">Call Enquiry</span>
        </button>
        <button 
          type="button"
        ...
        >
          ...
          <span className="text-[10px] font-medium leading-tight whitespace-nowrap overflow-hidden text-ellipsis max-w-full">More</span>
        </button>
        <button 
          type="button"
        ...
        >
          ...
          <span className="text-[10px] font-medium leading-tight whitespace-nowrap overflow-hidden text-ellipsis max-w-full">Profile</span>
        </button>
      </nav>
      <LoginModal 
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-[20px] z-[9999] shadow-[0_-4px_20px_rgba(0,0,0,0.15)] animate-[slideUp_0.3s_ease-out] max-h-[40vh] pb-[env(safe-area-inset-bottom)] md:hidden">
            ...
            <div className="flex justify-around items-center px-6 pb-8 gap-6">
              <div className="flex flex-col items-center justify-center cursor-pointer flex-1 p-4 rounded-xl transition-colors gap-2 active:bg-gray-100" onClick={handleAgentClick}>
                ...
                <span className="text-sm font-bold text-gray-700 text-center">Agent</span>
              </div>
              <div className="flex flex-col items-center justify-center cursor-pointer flex-1 p-4 rounded-xl transition-colors gap-2 active:bg-gray-100" onClick={handleVendorClick}>
                ...
                <span className="text-sm font-bold text-gray-700 text-center">Vendor</span>
              </div>
            </div>
          </div>
        </>
