  ...
  return (
    <>
      <nav className="bottom-navigation">
        ...
        <button 
          type="button"
          className={`nav-item ${isCallEnquiry ? 'active' : ''}`}
        ...
        <button 
          type="button"
          className={`nav-item ${showMoreBottomSheet ? 'active' : ''}`}
      ...
      {showMoreBottomSheet && (
        <>
          <div className="more-bottom-sheet-overlay" onClick={handleCloseMoreBottomSheet}></div>
          <div className="more-bottom-sheet">
            <div className="more-bottom-sheet-handle" onClick={handleCloseMoreBottomSheet}></div>
            <div className="more-bottom-sheet-content">
              <div className="more-bottom-sheet-option" onClick={handleAgentClick}>
                <div className="more-bottom-sheet-icon agent-icon">
                ...
                <span className="more-bottom-sheet-label">Agent</span>
              </div>
              <div className="more-bottom-sheet-option" onClick={handleVendorClick}>
                <div className="more-bottom-sheet-icon vendor-icon">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M3 9L12 2L21 9V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V9Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M9 22V12H15V22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <span className="more-bottom-sheet-label">Vendor</span>
              </div>
            </div>
          </div>
        </>
