...
function ContactUsPage() {
  ...
  return (
    <div className="fixed inset-0 w-full bg-white animate-[fadeInScale_0.3s_ease-out] overflow-y-auto flex flex-col">
      <div className="bg-gradient-to-br from-[#13335a] to-[#1e4a7a] px-[clamp(16px,2vw,24px)] py-[clamp(16px,2vw,20px)] flex justify-between items-center sticky top-0 z-10 flex-shrink-0">
        <button className="bg-transparent border-none cursor-pointer p-[clamp(3px,0.4vw,4px)] flex items-center justify-center transition-colors rounded-full w-[clamp(28px,3.5vw,32px)] h-[clamp(28px,3.5vw,32px)] hover:bg-white/20" onClick={() => navigate(-1)}>
          ...
          <h2 className="text-[clamp(18px,2.5vw,24px)] font-bold text-white m-0 flex-1 text-center leading-[1.3]">Contact Us</h2>
          <div style={{ width: '24px' }}></div>
        </div>

        <div className="px-[clamp(16px,2vw,24px)] md:px-[clamp(12px,1.5vw,16px)] flex-1 overflow-y-auto pb-[clamp(30px,3.5vw,40px)]">
          {/* Contact Cards */}
          <div className="flex flex-col gap-[clamp(12px,1.5vw,16px)] mb-[clamp(16px,2vw,24px)]">
            {/* Email */}
            <div className="bg-white border border-gray-200 rounded-[clamp(10px,1.2vw,12px)] p-[clamp(16px,2vw,20px)] md:p-[clamp(12px,1.5vw,16px)] flex items-center gap-[clamp(12px,1.5vw,16px)] shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-shadow hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)]">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-[clamp(14px,1.6vw,16px)] font-bold text-[#1a1a1a] m-0 mb-[clamp(3px,0.4vw,4px)] leading-[1.3]">Email</h4>
                <p className="text-[clamp(12px,1.4vw,14px)] text-gray-500 m-0 leading-[1.4] break-words">ourdealsservices@gmail.com</p>
              </div>
              <div className="flex gap-[clamp(6px,0.8vw,8px)] flex-shrink-0">
                <button className="bg-transparent border-none cursor-pointer p-[clamp(6px,0.8vw,8px)] flex items-center justify-center text-gray-500 transition-colors rounded-[clamp(6px,0.8vw,8px)] hover:bg-gray-100 hover:text-[#13335a]" onClick={() => handleCopy('ourdealsservices@gmail.com')}>
                ...
                <button className="bg-transparent border-none cursor-pointer p-[clamp(6px,0.8vw,8px)] flex items-center justify-center text-gray-500 transition-colors rounded-[clamp(6px,0.8vw,8px)] hover:bg-gray-100 hover:text-[#13335a]" onClick={() => handleLink('mailto:ourdealsservices@gmail.com')}>
            ...
            <div className="bg-white border border-gray-200 rounded-[clamp(10px,1.2vw,12px)] p-[clamp(16px,2vw,20px)] md:p-[clamp(12px,1.5vw,16px)] flex items-center gap-[clamp(12px,1.5vw,16px)] shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-shadow hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)]">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-[clamp(14px,1.6vw,16px)] font-bold text-[#1a1a1a] m-0 mb-[clamp(3px,0.4vw,4px)] leading-[1.3]">Customer Care</h4>
                <p className="text-[clamp(12px,1.4vw,14px)] text-gray-500 m-0 leading-[1.4] break-words">+91 9125959991</p>
              </div>
              <div className="flex gap-[clamp(6px,0.8vw,8px)] flex-shrink-0">
                <button className="bg-transparent border-none cursor-pointer p-[clamp(6px,0.8vw,8px)] flex items-center justify-center text-gray-500 transition-colors rounded-[clamp(6px,0.8vw,8px)] hover:bg-gray-100 hover:text-[#13335a]" onClick={() => handleCopy('+91 9125959991')}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[clamp(16px,2vw,20px)] h-[clamp(16px,2vw,20px)]">
                    <path d="M16 1H4C2.9 1 2 1.9 2 3V17H4V3H16V1Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M20 5H8C6.9 5 6 5.9 6 7V21C6 22.1 6.9 23 8 23H20C21.1 23 22 22.1 22 21V7C22 5.9 21.1 5 20 5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </button>
                <button className="bg-transparent border-none cursor-pointer p-[clamp(6px,0.8vw,8px)] flex items-center justify-center text-gray-500 transition-colors rounded-[clamp(6px,0.8vw,8px)] hover:bg-gray-100 hover:text-[#13335a]" onClick={() => handleCall('+919125959991')}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[clamp(16px,2vw,20px)] h-[clamp(16px,2vw,20px)]">
            ...
            <div className="bg-white border border-gray-200 rounded-[clamp(10px,1.2vw,12px)] p-[clamp(16px,2vw,20px)] md:p-[clamp(12px,1.5vw,16px)] flex items-center gap-[clamp(12px,1.5vw,16px)] shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-shadow hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)]">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-[clamp(14px,1.6vw,16px)] font-bold text-[#1a1a1a] m-0 mb-[clamp(3px,0.4vw,4px)] leading-[1.3]">Toll-Free / Landline</h4>
            ...
            <div className="bg-white border border-gray-200 rounded-[clamp(10px,1.2vw,12px)] p-[clamp(16px,2vw,20px)] md:p-[clamp(12px,1.5vw,16px)] flex items-center gap-[clamp(12px,1.5vw,16px)] shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-shadow hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)]">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-[clamp(14px,1.6vw,16px)] font-bold text-[#1a1a1a] m-0 mb-[clamp(3px,0.4vw,4px)] leading-[1.3]">Website</h4>
            ...
            <div className="bg-white border border-gray-200 rounded-[clamp(10px,1.2vw,12px)] p-[clamp(16px,2vw,20px)] md:p-[clamp(12px,1.5vw,16px)] flex items-center gap-[clamp(12px,1.5vw,16px)] shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-shadow hover:shadow-[0_4px_12px_rgba(0,0,0,0.1)]">
              ...
              <div className="flex-1 min-w-0">
                <h4 className="text-[clamp(14px,1.6vw,16px)] font-bold text-[#1a1a1a] m-0 mb-[clamp(3px,0.4vw,4px)] leading-[1.3]">Company</h4>
                <p className="text-[clamp(12px,1.4vw,14px)] text-gray-500 m-0 leading-[1.4] break-words">Our deals Services</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center py-[clamp(16px,2vw,24px)] border-t border-gray-200 mt-[clamp(16px,2vw,24px)]">
            <p className="text-[clamp(12px,1.4vw,14px)] text-gray-500 m-0 leading-[1.5]">© 2025 Our deals Services</p>
          </div>
        </div>
    </div>
  )
